...
var _default = (function (_think$middleware$base) {
    ...
    _default.prototype.setAllowedHeaders = function setAllowedHeaders(options, req) {
    ...
    _default.prototype.setExposedHeaders = function setExposedHeaders(options) {
    ...
    _default.prototype.run = function run() {
        ...
        var headers = [this.setOrigin(options, req), this.setCredentials(options, req), this.setExposedHeaders(options, req)];
