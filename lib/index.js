...
var _default = (function (_think$middleware$base) {
    ...
    _default.prototype.isOriginAllowed = function isOriginAllowed(origin, allowedOrigin) {
        ...
        if (Array.isArray(allowedOrigin)) {
            allowedOrigin.forEach(function (originItem) {
                if (_this.isOriginAllowed(origin, originItem)) {
                    return true;
                }
            });
    ...
    _default.prototype.configureOrigin = function configureOrigin(options, req) {
    ...
    _default.prototype.configureMethods = function configureMethods(options) {
    ...
    _default.prototype.configureCredentials = function configureCredentials(options) {
    ...
    _default.prototype.configureAllowedHeaders = function configureAllowedHeaders(options, req) {
    ...
    _default.prototype.configureExposedHeaders = function configureExposedHeaders(options) {
    ...
    _default.prototype.configureMaxAge = function configureMaxAge(options) {
        ...
        headers.forEach(function (header) {
            if (header) {
                if (Array.isArray(header)) {
                    _this2.applyHeaders(header, res);
    ...
    _default.prototype.configureOptions = function configureOptions(opts) {
