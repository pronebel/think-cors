...
var _default = (function (_think$middleware$base) {
    ...
    _default.prototype.run = function run() {
        ...
        var headers = [this.configureOrigin(options, req), this.configureCredentials(options, req), this.configureExposedHeaders(options, req)];
